...
홀그렌(Hallgren)이 보인 바와 같이, 이는 양자 컴퓨터로 다항 시간에 해결할 수 있다 [[49](/QAZKR/appendix/references.html#49)].
적은 큐비트를 사용하는 수정된 양자 알고리즘은 [[131](/QAZKR/appendix/references.html#131)]에 제시되어 있다.
임의 차수의 수체에서 주아이디얼을 찾는 양자 알고리즘은 (이를테면, 차수에 따라 다항적으로 커지는) [[329](/QAZKR/appendix/references.html#329)]에 제시되어 있다.
